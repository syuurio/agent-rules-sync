...
## Rule 0: Project Context Bootstrapping (Mandatory)
...
- During this scan, the agent must locate, read, and understand any of the following files if present:
  - `AGENTS.md`
  - `CONTRIBUTING.md`
  - Agent- or tool-specific configuration files (e.g., `CLAUDE.md`, `.cursorrules`, `.ai-rules`)
...
## Rule 1: Documentation & Tooling Priority
...
## Rule 3: Code Style, Linting & Formatting
...
## Rule 4: Assumptions & Safety Defaults
